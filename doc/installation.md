...
```zsh
sudo apt update
sudo apt -y rofi zsh i3 i3lock suckless-tools xfonts-terminus xscreensaver taskwarrior hsetroot fzf git curl wget nvim nvm gnome-sushi snapd dconf-cli maim pulseaudio alsa py3status
